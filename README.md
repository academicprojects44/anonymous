...
- ColBERTv2 from  PyLate
- HDBSCAN  
- NumPy, pandas, scikit-learn  

Dependencies can be installed based on the imports used in the scripts. We are using LaMP_1 as an example in the execution steps. Replace LaMP_1 with the desired task.
